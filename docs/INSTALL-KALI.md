...
```bash
curl -LO https://github.com/cknb6/ck-wifikiller/releases/download/v2.5.29/ck-wifikiller_2.5.29_all.deb
sudo apt install -y ./ck-wifikiller_2.5.29_all.deb
```
