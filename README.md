...
[![Release](https://img.shields.io/badge/Release-v2.5.12-success)](https://github.com/cknb6/ck-wifikiller/releases)

```
GitHub:  https://github.com/cknb6/ck-wifikiller
Version: CK_WIFI_VERSION env > git describe > 2.5.12-ck
Author:  传康Kk（万能程序员）
...
```bash
git tag v2.5.12 && git push origin v2.5.12
```
