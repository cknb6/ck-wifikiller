...
[![Release](https://img.shields.io/badge/Release-v2.5.8-success)](https://github.com/cknb6/ck-wifikiller/releases)

```
GitHub:  https://github.com/cknb6/ck-wifikiller
Version: CK_WIFI_VERSION env > git describe > 2.5.8-ck
Author:  传康Kk（万能程序员）
...
```bash
curl -LO https://github.com/cknb6/ck-wifikiller/releases/download/v2.5.8/ck-wifikiller_2.5.8_all.deb
sudo apt install -y ./ck-wifikiller_2.5.8_all.deb
```
